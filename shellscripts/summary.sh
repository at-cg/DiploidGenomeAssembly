...
PATFASTA="/home/daanish/data/HG002/p$ERR/chr19_mat_to_pat.txt"
EXE=/home/daanish/projects/DiploidGenomeAssembly/src/prepare.py

python3 $EXE -mpath $MATFASTA -ppath $PATFASTA -err $ERR

# Data analysis
cd /home/daanish/projects/DiploidGenomeAssembly/
if [ ! -d "p$ERR" ]; then
    mkdir "p$ERR"
fi

OUT="/home/daanish/projects/DiploidGenomeAssembly/p$ERR/"
...
OPATH="/home/daanish/projects/DiploidGenomeAssembly/plot/p$ERR.png"
EP=0.01
